                                        ...
                                        <form action="#">
                                            ...
                                            <div class="payment-widget">
                                                ...
                                                <div class="submit-section mt-4">
                                                    ...
                                                    <nuxt-link to="/patient/bookingsuccess" class="btn btn-primary submit-btn">Confirm and Pay</nuxt-link>
                                                </div>
                                                <!-- /Submit Section -->
                                ...
                                <div class="card booking-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="booking-doc-info">
                                            <nuxt-link to="/patient/doctorprofile" class="booking-doc-img">
                                                <img src="~/assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
                                            </nuxt-link>
                                            <div class="booking-info">
                                                <h4><nuxt-link to="/patient/doctorprofile">Dr. Darren Elder</nuxt-link></h4>
                                                <div class="rating">
