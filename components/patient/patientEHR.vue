                            ...
                            <div class="col-md-12 col-12">
                                <nav aria-label="breadcrumb" class="page-breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">My Clinical History</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            <div class="row form-row">
                                                ...
                                                <div class="col-md-12 dropzone-b mb-20">
                                                    <div class="form-group dropzone-b">
                                                        <label>Are you experiencing symptoms at these areas?</label>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div class="col-12 col-md-12">
                                                    <div class="form-group">
                                                        <div class="mb-10">
                                                            <label>Is your current healthcare coverage</label>&nbsp;
                                                                <select class="form-contro select">
                                                                    <option>public</option>
                                                                    <option>private</option>
                                                                </select> &nbsp;?
                                                        </div>
                                                        <textarea type="text" class="form-control h-150" value="" placeholder="Describe the insurance card number"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <a class="btn btn-primary submit-btn fw">Delete my EHR</a>
