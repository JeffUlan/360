                        ...
                        <div class="call-wrapper">
                            <div class="call-inner">
                                ...
                                <div class="call-items">
                                    ...
                                    <nuxt-link to="/doctor/doctorvoicecall" class="btn call-item call-start" aria-label="Close" data-dismiss="modal"><i class="material-icons">call</i></nuxt-link>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="call-wrapper">
                            <div class="call-inner">
                                ...
                                <div class="call-items">
                                    ...
                                    <nuxt-link to="/doctor/doctorvideocall" class="btn call-item call-start" aria-label="Close" data-dismiss="modal"><i class="material-icons">videocam</i></nuxt-link>
                                </div>
                            </div>
                        </div>
                    </div>
